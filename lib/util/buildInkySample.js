...
<p class="docs-code-demo-title subtitle">DEMO</p>
<div class='docs-code-container'>
  <iframe class="docs-code-iframe" src="examples/{3}"></iframe>
  <div class="docs-code-wrapper">
    <span class="docs-code-language" data-docs-code-current>Inky</span>
    <button class="docs-code-toggle" type="button" data-docs-code-toggle>Switch to HTML</button>
